...
var botao_3 = document.getElementById("3"); /* criar variavel para botão quando criamos uma id também, e usamos a função a partir do botão. Adicionar evento na função para saber quando o usuário clica ou passa pelo botão*/
botao_3.addEventListener("click", () => [
    document.getElementById("textosobremim").innerHTML = "<ul class = 'coluna'><li><strong> NPDEAS (Núcleo de Pesquisa e Desenvolvimento de Energia Autossustentável).</strong> 2021 -2024. <br><br> </li> <li> Funções: Cultivo de microalgas em pequena e grande escala; Realização de análises químicas; Auxílio em aplicações biotecnológicas de microalgas; Assistência na produção de biorreatores de nível industrial. Produção de artigos científicos; Utilização de pacote office e de softwares para aperfeiçoamento de processos relacionados a biorrefinaria de microalgas. <br> <br> </li> <li> <strong>LAGEAMB (Laboratório de Geoprocessamento e Estudos Ambientais). </strong> 2024 - 2025 <br><br> Funções: Atuação em projetos vinculados ao programa TED/INCRA; monitoramento e sistematização de indicadoresde extensão; Gestão de conteúdo dos canais decomunicação internos, trabalho com ferramentas de gestão de projetos.",
    img_eu.style.backgroundImage = `url('Imagens/lageamb.png')`,
    img_eu.style.backgroundSize = 'cover'
])

var botao_4 = document.getElementById("4"); /* criar variavel para botão quando criamos uma id também, e usamos a função a partir do botão. Adicionar evento na função para saber quando o usuário clica ou passa pelo botão*/
...
var botao_5 = document.getElementById("5"); /* criar variavel para botão quando criamos uma id também, e usamos a função a partir do botão. Adicionar evento na função para saber quando o usuário clica ou passa pelo botão*/
